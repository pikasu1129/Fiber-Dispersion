...
if __name__ == '__main__':
	...
	# Initialization of the nessecary arrays
	...
	#-----------------------------------------------
	#   Plot the input NRZ train pulses
	#-----------------------------------------------
	...
	#-----------------------------------------------------
	#   Plot the NRZ pulses (with chromatic dispersion)
	#-----------------------------------------------------
	...
	#-----------------------------------------------------------------------------------------	
	#   Plot the onesided spectrum of the NRZ pulses (with or without chromatic dispersion)
	#-----------------------------------------------------------------------------------------	
	...
	plt.title('Onesided Spectrum of the NRZ pulses', fontsize=16)		
	plt.grid()
	...
	#------------------------------------------------------------------------
	#   Plot the FIR filter which counterbalances the chromatic dispersion
	#------------------------------------------------------------------------
	...
	for i in range(0,len(z)):
		...
		plt.xlabel("Number of taps", fontsize=12)
		...
		plt.xlim(k[i,0],k[i,N[i]-1])
		plt.xlabel("Number of taps", fontsize=12)
		plt.ylabel("Normalized phase [1/pi]", fontsize=12)
		plt.grid()
	plt.suptitle("The FIR filter which counterbalances the chromatic dispersion.", fontsize=16)
	...
	#---------------------------------------------
	#   Plot the signal after CD compensation
	#---------------------------------------------
